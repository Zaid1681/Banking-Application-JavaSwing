...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem() {
		...
		allCustomer = new JMenuItem("View All Accounts", new ImageIcon("Images/refresh.gif"));
		...
		all = new JMenuItem("View All Accounts",new ImageIcon("Images/searchmenu.png"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			String msg = "Banking App JAVA MINIPROJECT.\n\n" + "Created & Designed By:\n"
					+ "Abhishek Jani\nZaid Khan\nJayesh Khandare\nSaurabh Jagtap\n\n"
