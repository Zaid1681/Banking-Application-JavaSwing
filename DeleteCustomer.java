...
public class DeleteCustomer extends JInternalFrame implements ActionListener {
	...
	DeleteCustomer() {
		...
		lbNo.setBounds(15, 20, 170, 35);
		lbNo.setFont(new Font("Montserrat", Font.PLAIN, 17));

		lbName = new JLabel("Person Name:");
		lbName.setForeground(Color.black);
		lbName.setBounds(15, 65, 170, 35);
		lbName.setFont(new Font("Montserrat", Font.PLAIN, 17));

		lbDate = new JLabel("Last Transaction:");
		lbDate.setForeground(Color.black);
		lbDate.setBounds(15, 110, 170, 35);
		lbDate.setFont(new Font("Montserrat", Font.PLAIN, 17));

		lbBal = new JLabel("Balance:");
		lbBal.setForeground(Color.black);
		lbBal.setBounds(15, 155, 170, 35);
		lbBal.setFont(new Font("Montserrat", Font.PLAIN, 17));

		txtNo = new JTextField();
		txtNo.setHorizontalAlignment(JTextField.RIGHT);
		txtNo.setBounds(175, 20, 250, 35);

		txtName = new JTextField();
		txtName.setEnabled(false);
		txtName.setBounds(175, 65, 250, 35);

		txtDate = new JTextField();
		txtDate.setEnabled(false);
		txtDate.setBounds(175, 110, 250, 35);
		
		txtBal = new JTextField();
		txtBal.setEnabled(false);
		txtBal.setHorizontalAlignment(JTextField.RIGHT);
		txtBal.setBounds(175, 155, 250, 35);

		// Aligning The Buttons.
		btnDel = new JButton("Delete");
		btnDel.setBounds(85, 220, 120, 35);
		btnDel.addActionListener(this);
		btnCancel = new JButton("Cancel");
		btnCancel.setBounds(245, 220, 120, 35);
