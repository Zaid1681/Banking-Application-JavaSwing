...
public class WithdrawMoney extends JInternalFrame implements ActionListener {
	...
	WithdrawMoney () {
		...
		lbWithdraw.setBounds (70, 185, 150, 35);
		lbWithdraw.setFont(new Font("Montserrat", Font.PLAIN, 20));
		...
		txtWithdraw.setBounds (285, 185, 205, 35);
		txtWithdraw.setFont(new Font("Montserrat", Font.PLAIN, 15));
	...
	public void editRec () {
		...
		records[recCount][7] = "" + (curr - withdraw);
